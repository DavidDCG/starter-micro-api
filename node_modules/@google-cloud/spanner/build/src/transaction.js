...
exports.PartitionedDml = exports.Transaction = exports.Dml = exports.Snapshot = void 0;
...
class Snapshot extends events_1.EventEmitter {
    ...
    constructor(session, options, queryOptions) {
        ...
        this.resourceHeader_ = {
            [common_1.CLOUD_RESOURCE_HEADER]: this.session.parent.formattedName_,
        };
    ...
    createReadStream(table, request = {}) {
        ...
        return (_c = (0, partial_result_stream_1.partialResultStream)(this._wrapWithIdWaiter(makeRequest), {
            json,
            jsonOptions,
            maxResumeRetries,
        })) === null || _c === void 0 ? void 0 : _c.on('response', response => {
    ...
    runStream(query) {
        ...
        return (0, partial_result_stream_1.partialResultStream)(this._wrapWithIdWaiter(makeRequest), {
            json,
            jsonOptions,
            maxResumeRetries,
        })
...
class Transaction extends Dml {
    ...
    batchUpdate(queries, optionsOrCallback, cb) {
        ...
        const reqOpts = {
            session: this.session.formattedName_,
            requestOptions: this.configureTagOptions(false, (_b = (_a = this.requestOptions) === null || _a === void 0 ? void 0 : _a.transactionTag) !== null && _b !== void 0 ? _b : undefined, options.requestOptions),
            transaction,
            seqno: this._seqno++,
            statements,
        };
